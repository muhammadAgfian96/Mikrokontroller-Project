...
void setup() {
  ...
  sudut_pos = 45;
  set_point = 800;
  NAMA_BERKAS = "SERVO_NUTRISI_" + String(sudut_pos) + ".txt";
  ...
  xKolom = "tanngal;jam;ppm;ec;sudut";
  write_data(xKolom);
  delay(3000);
}
...
void loop() {
  ...
  jalankan_servo_nutrisi(sudut_pos);
  //  jalankan_servo_air(sudut_pos);
